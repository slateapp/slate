...
# description, student_id, solved, category_id, teacher_id, solved_at, created_at
  ...
  ["One more for good luck!"                    ,1,true,7,2,Time.now-15.minutes,    Time.now-20.minutes]].each{|request|
    Request.create(description: request[0], student_id: request[1], solved: request[2], category_id: request[3], teacher_id: request[4], solved_at: request[5], created_at: request[6])
  }
